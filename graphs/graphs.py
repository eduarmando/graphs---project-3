...
import time
import random
from graphs import SimulatedAnnealing as sa
from graphs import Salesman1 as sm
...
def procesar1():
    ...
    pos = {
        'Colotlan': [22.11, -103.26],
        'Tala': [20.54, -103.7],
        'Ameca': [20.54, -104.04],
        'Puerto Vallarta': [20.65, -105.22],
        'Autlan de Navarro': [19.77, -104.36],
        'Tecolotlan': [20.20, -104.04],
        'Tapalpa': [19.94, -103.76],
        'Guadalajara': [20.65, -103.35],
        'Ciudad Guzman': [19.70, -103.46],
        'Ajijic': [20.29, -103.26],
        'Zapotlanejo': [20.61, -103.06],
        'Ocotlan': [20.34, -102.76],
        'Tepatitlan': [20.80, -102.76],
        'La Barca': [20.29, -102.54],
        'Degollado': [20.44, -102.13],
        'Arandas': [20.70, -102.34],
        'Jalostotitlan': [21.16, -102.46],
        'San Juan de los Lagos': [21.24, -102.33],
        'Lagos de Moreno': [21.26, -101.92],
        'Encarnacion de Diaz': [21.52, -102.24]
    }
    datos = []
    ...
    nx.draw_networkx_edges(
        G, pos, edgelist=elarge, width=2, alpha=0.5, edge_color='r')
    ...
    print("Distancia: ",
          nx.shortest_path_length(G, origen, destino,
                                  weight='weight'))  # distancia mas corta
    plt.axis('off')
    plt.show()
    ...
    nombres = ("Colotlan", "Encarnacion de Diaz", "Lagos de Moreno",
               "San Juan de los Lagos", "Jalostotitlan", "Tepatitlan",
               "Arandas", "Zapotlanejo", "Degollado", "La Barca", "Ocotlan",
               "Ajijic", "Guadalajara", "Tala", "Ameca", "Tecolotlan",
               "Tapalpa", "Ciudad Guzman", "Puerto Vallarta",
               "Autlan de Navarro")
    datos = [[22.11, -103.26], [21.52, -102.24], [21.26, -101.92], [
        21.24, -102.33
    ], [21.16, -102.46], [20.80, -102.76], [20.70, -102.34], [20.61, -103.06],
             [20.44, -102.13], [20.29, -102.54], [20.34, -102.76], [
                 20.29, -103.26
             ], [20.65, -103.35], [20.54, -103.7], [20.54,
                                                    -104.04], [20.20, -104.04],
             [19.94, -103.76], [19.70, -103.46], [20.65,
                                                  -105.22], [19.77, -104.36]]
    points = datos
    print(nombres)
